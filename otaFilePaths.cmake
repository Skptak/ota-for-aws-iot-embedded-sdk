...
set(OTA_INCLUDE_PUBLIC_DIRS "${CMAKE_CURRENT_LIST_DIR}/source/include"
                            "${CMAKE_CURRENT_LIST_DIR}/source/portable")

# OTA library private include directories.
set(OTA_INCLUDE_PRIVATE_DIRS "${CMAKE_CURRENT_LIST_DIR}/source")

# OTA library POSIX OS porting source files. Note: user needs to call
# find_library(LIB_RT rt REQUIRED) and link with ${LIB_RT} because librt is
# required to use OTA OS POSIX port.
...
set(OTA_INCLUDE_OS_POSIX_DIRS "${CMAKE_CURRENT_LIST_DIR}/source/portable/os")
...
# OTA library FreeRTOS OS porting source files.
set(OTA_INCLUDE_OS_FREERTOS_DIRS "${CMAKE_CURRENT_LIST_DIR}/source/portable/os")
