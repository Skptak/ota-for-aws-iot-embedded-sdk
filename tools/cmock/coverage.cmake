...
execute_process(
  COMMAND
    lcov --rc lcov_branch_coverage=1 --remove ${CMAKE_BINARY_DIR}/coverage.info
    *dependency* *unit-test* /usr* */source/ota.c *CMakeCCompilerId*
    */source/portable/os/ota_os_posix.c --output-file
...
execute_process(COMMAND lcov --rc lcov_branch_coverage=1 --list
                        ${CMAKE_BINARY_DIR}/coverage.info)
